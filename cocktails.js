...
(function () {
  ...
  const CURATED_RECIPES = [
    ...
    { name: 'Boulevardier',
      required: [{ category: 'Whiskey', amount: '1 oz' }, { category: 'Liqueur', amount: '1 oz', note: 'Campari' }, { category: 'Sweet Vermouth', amount: '1 oz' }],
    ...
    { name: 'Negroni',
      required: [{ category: 'Gin', amount: '1 oz' }, { category: 'Liqueur', amount: '1 oz', note: 'Campari' }, { category: 'Sweet Vermouth', amount: '1 oz' }],
      optional: [{ item: 'orange peel', amount: '1 twist' }],
